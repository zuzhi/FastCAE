...
namespace FastCAEDesigner{
		...
		ui(new Ui::ParaImportMeshSetup)
	{
		...
		connect(ui->chk_cntm, SIGNAL(clicked()), this, SLOT(CancelCheckAll()));
		connect(ui->chk_su2, SIGNAL(clicked()), this, SLOT(CancelCheckAll()));
		connect(ui->chk_key, SIGNAL(clicked()), this, SLOT(CancelCheckAll()));
		connect(ui->chk_pdb, SIGNAL(clicked()), this, SLOT(CancelCheckAll()));
		connect(ui->chk_bdf, SIGNAL(clicked()), this, SLOT(CancelCheckAll()));
		//初始化导入网格类型
